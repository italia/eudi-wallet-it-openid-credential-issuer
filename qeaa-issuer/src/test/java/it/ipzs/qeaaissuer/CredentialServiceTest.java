...
class CredentialServiceTest {
	...
	void testGenerateSdCredentialResponse()
		...
		CredentialDefinitionDto cred = new CredentialDefinitionDto();
		cred.setType(List.of("mDL"));
		when(sessionUtil.getSessionInfo(any())).thenReturn(si);
		// Test
		CredentialResponse response = credentialService.generateSdCredentialResponse(null, proofClaims, cred);
