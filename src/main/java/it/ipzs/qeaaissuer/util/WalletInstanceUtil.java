...
import it.ipzs.qeaaissuer.exception.WIAConfigurationRetrievalException;
import it.ipzs.qeaaissuer.exception.WalletInstanceAttestationVerifyException;
	...
	public void validateWalletInstance(String walletInstance) throws ParseException, JOSEException {
		...
		if (jwk != null && jwk instanceof ECKey ecKey) {
			try {
				...
				throw new WalletInstanceAttestationVerifyException("Wallet Instance Attestation JWT not verified");
			}
