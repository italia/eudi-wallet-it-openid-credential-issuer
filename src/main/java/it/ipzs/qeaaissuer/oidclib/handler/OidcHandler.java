package it.ipzs.qeaaissuer.oidclib.handler;
...
import it.ipzs.qeaaissuer.oidclib.FederationEntityOptions;
import it.ipzs.qeaaissuer.oidclib.GlobalOptions;
import it.ipzs.qeaaissuer.oidclib.OIDCConstants;
import it.ipzs.qeaaissuer.oidclib.OIDCCredentialIssuerOptions;
import it.ipzs.qeaaissuer.oidclib.RelyingPartyOptions;
...
import it.ipzs.qeaaissuer.oidclib.exception.RelyingPartyException;
import it.ipzs.qeaaissuer.oidclib.exception.SchemaException;
import it.ipzs.qeaaissuer.oidclib.exception.TrustChainException;
import it.ipzs.qeaaissuer.oidclib.helper.EntityHelper;
import it.ipzs.qeaaissuer.oidclib.helper.JWTHelper;
import it.ipzs.qeaaissuer.oidclib.helper.OAuth2Helper;
import it.ipzs.qeaaissuer.oidclib.helper.OIDCHelper;
import it.ipzs.qeaaissuer.oidclib.helper.PKCEHelper;
...
import it.ipzs.qeaaissuer.oidclib.model.EntityConfiguration;
import it.ipzs.qeaaissuer.oidclib.model.FederationEntity;
import it.ipzs.qeaaissuer.oidclib.model.TrustChain;
import it.ipzs.qeaaissuer.oidclib.model.TrustChainBuilder;
import it.ipzs.qeaaissuer.oidclib.persistence.PersistenceAdapter;
import it.ipzs.qeaaissuer.oidclib.schemas.CIEClaimItem;
import it.ipzs.qeaaissuer.oidclib.schemas.ClaimItem;
import it.ipzs.qeaaissuer.oidclib.schemas.OIDCProfile;
import it.ipzs.qeaaissuer.oidclib.schemas.ProviderButtonInfo;
import it.ipzs.qeaaissuer.oidclib.schemas.SPIDClaimItem;
import it.ipzs.qeaaissuer.oidclib.schemas.Scope;
import it.ipzs.qeaaissuer.oidclib.schemas.TokenResponse;
import it.ipzs.qeaaissuer.oidclib.schemas.WellKnownData;
import it.ipzs.qeaaissuer.oidclib.util.JSONUtil;
import it.ipzs.qeaaissuer.oidclib.util.ListUtil;
...
public class OidcHandler {
	...
	private WellKnownData prepareOnboardingData(String sub, boolean jsonMode)
		...
		RSAKey encrKey = JWTHelper.parseRSAKey(encrJwk);
